    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SignTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SignTasks_Dossiers_DossierId",
                        column: x => x.DossierId,
                        principalTable: "Dossiers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SignTasks_Users_AssigneeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SignTasks_AssigneeId",
                table: "SignTasks",
                column: "AssigneeId");

            migrationBuilder.CreateIndex(
                name: "IX_SignTasks_DossierId_Order",
                table: "SignTasks",
                columns: new[] { "DossierId", "Order" },
                unique: true);
